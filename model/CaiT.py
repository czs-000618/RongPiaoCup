...
# helpers
from visualize.visualizer import get_local
...
class Attention(nn.Module):
    ...
    def forward(self, x, context=None):
        ...
        after_dots = einsum('b h i j, h g -> b g i j', dots, self.mix_heads_pre_attn)  # talking heads, pre-softmax

        attn = self.attend(after_dots)
